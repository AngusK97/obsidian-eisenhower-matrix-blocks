...
Captured on 2026-09-24 with the 2.8.1 production renderer in the browser test harness. The Obsidian shell and icons are simulated; these are not native Obsidian screenshots. Both READMEs disclose this distinction.
