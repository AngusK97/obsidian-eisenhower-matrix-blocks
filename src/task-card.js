...
const { getDueDateInfo } = require("./task-details");
const { createDueDateControl } = require("./task-fields");
...
function renderQuickAdd(section, renderer, quadrant, quadrantName) {
	...
	const dateControl = createDueDateControl(details, plugin, draft.dueDate, (value) => { draft.dueDate = value; });
